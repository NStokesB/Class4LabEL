 ...
 */
@WebServlet(name = "ShapesController", urlPatterns = {"/shapeCal"})
public class ShapesController extends HttpServlet {
    private final String RESPONSE_PAGE = "/Lab2and3.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       if( request.getParameter("shapeID").equals(RECTANGLE) ){             
            ...
            RectangleService rectangleServ = new RectangleService(length, width);
